    ...
    $("#formulario").bind("submit",function(){
          ...
          $.ajax({
              ...
              beforeSend: function(data){
                  btnEnviar.val('<i class="fa fa-spinner fa-spin"></i> Enviando'); // Para input de tipo button
              ...
              success: function(data){
                if(data=='OK'){
                  ...
                  btnEnviar.val('OK'); // Para input de tipo button
                  btnEnviar.attr("disabled","disabled");
                }else{
                  $("#respuesta").html("Error, Intenteló nuevamente");
                  btnEnviar.html('OK'); // Para input de tipo button
                  btnEnviar.prop('disabled');
                  }
              },
              error: function(data){
                  $("#respuesta").html('Error AJAX');
              }
          });
